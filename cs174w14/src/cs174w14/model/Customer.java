...
public class Customer {
	...
	private void fillFromResultSet(ResultSet rs) throws SQLException{
		...
		this.address_addr=rs.getString("address_addr");
		this.city_addr=rs.getString("city_addr");
		this.state_addr=rs.getString("state_addr");
		this.zip_addr=rs.getString("zip_addr");
